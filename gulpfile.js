...
var theme = g.util.env.theme || 'showcase';
...
function index() {
    ...
    return gulp.src('./src/app/index.html')
        .pipe(g.inject(gulp.src('./src/themes/' + theme + '/assets/js/*.js'), {
            addRootSlash: false,
            ignorePath: 'src/themes/' + theme,
            starttag: '<!-- inject:vendorTheme -->'
        }))
        ...
        .pipe(g.inject(es.merge(appFiles(), cssFiles('./.tmp/**/*.css', opt)), {
            addRootSlash: false,
            ignorePath: ['.tmp', 'src/app', 'src/themes/' + theme]
        }))
...
gulp.task('dist', ['clean-dist', 'vendors', 'assets', 'styles-dist', 'scripts-dist'], function () {
    return gulp.src('./src/app/index.html')
        ...
        .pipe(g.inject(cssFiles('./dist/**/*.css', {}), {
            addRootSlash: false,
            ignorePath: ['dist', 'src/app', 'src/themes/' + theme]
        }))
